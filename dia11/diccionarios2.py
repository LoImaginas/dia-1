...
cant_mascotas = int(input("Ingrese cantidad de mascotas"))#3
...
for i in range(cant_mascotas):#0,1,2
    ...
    for clave in mascota:
        #print(clave)
        mascota[clave] = input(f"Ingrese el {clave} de su mascota> ")


    for key in mascota.keys():
        #print(key)
        mascota[key] = input(f"Ingrese el {key} de su mascota> ")
