...
def posiciones_sobre_promedio(velocidades):
    #Identifica las posiciones de las correas transportadoras cuyas velocidades están por encima del promedio.
...
velocidad = [25, 12, 19, 16, 11, 11, 24, 1,
    ...
    # Calcular las posiciones de las correas transportadoras que están por encima del promedio e imprimir resultado
posiciones = posiciones_sobre_promedio(velocidad)
print(posiciones_sobre_promedio(velocidad))



#python3 dia13_desafio4/velocidad.py